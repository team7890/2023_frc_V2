...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleEncoder = new CANCoder(moduleConstants.cancoderID, "rio");     // Added "FastCAN" network (bc it's wired on canivore)
        configAngleEncoder();

        /* Angle Motor Config */
        mAngleMotor = new TalonFX(moduleConstants.angleMotorID, "FastCAN");     // Added "FastCAN" network (bc it's wired on canivore)
        configAngleMotor();

        /* Drive Motor Config */
        mDriveMotor = new TalonFX(moduleConstants.driveMotorID, "FastCAN");     // Added "FastCAN" network (bc it's wired on canivore)
        configDriveMotor();
