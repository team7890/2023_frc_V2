...
public class ScoreConeTopBalance extends SequentialCommandGroup {
  ...
  public ScoreConeTopBalance(Arm_subsystem objArm, Forearm_subsystem objForearm, Wrist_subsystem objWrist, RollerHand_subsystem objRollerHand, Swerve_subsystem objSwerve) {
