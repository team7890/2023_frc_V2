...
package frc.robot.commands.Button_commands.AutoOnly;
...
public class BingoBongoScoreConeTop extends CommandBase {
  ...
  double dWristTarget = 82.5;

  /** Creates a new ScoreCubeTop. */
  public BingoBongoScoreConeTop(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
