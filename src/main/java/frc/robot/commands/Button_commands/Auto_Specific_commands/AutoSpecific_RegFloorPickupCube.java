...
package frc.robot.commands.Button_commands.Auto_Specific_commands;
...
public class AutoSpecific_RegFloorPickupCube extends CommandBase {
  ...
  public AutoSpecific_RegFloorPickupCube(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
