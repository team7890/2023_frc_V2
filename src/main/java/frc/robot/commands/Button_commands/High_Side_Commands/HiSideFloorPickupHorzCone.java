...
public class HiSideFloorPickupHorzCone extends CommandBase {
  ...
  double dArmTarget = 15.5;
  double dForearmTarget = 157.2;
  double dWristTarget = -62.4;


  /** Creates a new ScoreCubeTop. */
  public HiSideFloorPickupHorzCone(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
