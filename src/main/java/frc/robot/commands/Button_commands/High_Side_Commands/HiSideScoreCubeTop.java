...
public class HiSideScoreCubeTop extends CommandBase {
  ...
  public HiSideScoreCubeTop(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
