...
public class HiSideSingleSubConePos extends CommandBase {
  ...
  double dArmTarget = -34.8;
  double dForearmTarget = 165.8;
  double dWristTarget = -60.5;


  /** Creates a new ScoreCubeTop. */
  public HiSideSingleSubConePos(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
