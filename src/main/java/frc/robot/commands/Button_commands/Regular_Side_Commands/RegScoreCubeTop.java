...
public class RegScoreCubeTop extends CommandBase {
  ...
  double dArmTarget = -42.6;
  double dForearmTarget = -23.8;
  double dWristTarget = -66.6;

  /** Creates a new ScoreCubeTop. */
  public RegScoreCubeTop(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
