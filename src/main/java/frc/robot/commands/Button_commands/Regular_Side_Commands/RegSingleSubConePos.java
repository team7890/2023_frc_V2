...
public class RegSingleSubConePos extends CommandBase {
  ...
  double dForearmTarget = -126.1;
  double dWristTarget = 89.2;


  /** Creates a new ScoreCubeTop. */
  public RegSingleSubConePos(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
