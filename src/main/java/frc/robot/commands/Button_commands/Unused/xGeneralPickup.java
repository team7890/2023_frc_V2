...
public class xGeneralPickup extends CommandBase {
  ...
  public xGeneralPickup(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
