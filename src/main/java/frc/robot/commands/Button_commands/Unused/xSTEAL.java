...
public class xSTEAL extends CommandBase {
  ...
  double dForearmTarget = 111.0;
  double dWristTarget = 0.0;

  /** Creates a new ScoreCubeTop. */
  public xSTEAL(Arm_subsystem objArm_in, Forearm_subsystem objForearm_in, Wrist_subsystem objWrist_in) {
    objArm = objArm_in;
  ...
  public void execute() {
    ...
    dForearmAngle_old = objForearm.getForearmAngle();
    dWristAngle_old = objWrist.getWristAngle();
    // System.out.println("STEAL - state: " + iState);     //For Testing
  }
