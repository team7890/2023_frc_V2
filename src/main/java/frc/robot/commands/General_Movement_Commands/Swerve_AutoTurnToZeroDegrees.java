...
public class Swerve_AutoTurnToZeroDegrees extends CommandBase {
  ...
  public Swerve_AutoTurnToZeroDegrees(Swerve_subsystem objSwerve_in) {
  ...
  public void execute() {
    ...
    dRotate = Utilities.limitVariable(-0.8, dRotate, 0.8);
  ...
  public boolean isFinished() {
    return Math.abs(dTargetAngle - dYawAngle) < 4.0;
  }
}
